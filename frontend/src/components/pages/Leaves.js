...
// };
// const data = [
//     { id: "L1", leavetype: "Casual Leave", from: "30 Oct 2022", to: "2 Nov 2022", num: 4, reason: "Sister's marriage", status: "New" },
//     { id: "L2", leavetype: "Medical Leave", from: "31 Oct 2022", to: "1 Nov 2022", num: 2, reason: "Going to Hospital", status: "Approved" },
//     { id: "L3", leavetype: "Loss of Pay", from: "1 Nov 2022", to: "1 Nov 2022", num: 1, reason: "Medical emergency", status: "Pending" },
// ]
...
//                         <button className="btn add-btn" onClick={setModalOpen} ><i
//                             className="fa fa-plus" ></i>Add Leave</button>
...
//                                                         <a className="dropdown-item" href={NULLURL} data-bs-toggle="modal" data-target="#edit_leave"><i class="fa fa-pencil m-r-5"></i> Edit</a>
//                                                         <a className="dropdown-item" href={NULLURL} data-bs-toggle="modal" data-target="#delete_approve"><i class="fa fa-trash-o m-r-5"></i> Delete</a>
//                                                     </div>
//                                                 </div>
//                                             </td>
//                                         </tr>
